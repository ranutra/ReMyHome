    ...
    return (
        ...
        {reviews.length === 0 && (<p className="font-normal">0</p>)} */}
            ...
            <button
                ...
                onClick={handleClick}
                className={cn(
                    "opacity-0 group-hover:opacity-100 transition absolute top-3 right-3 text-muted-foreground hover:text-green-600",
            ...
            >
                <Heart
                    className={cn(
                        "h-4 w-4",
                        isFavorite && "fill-green-600 text-green-600"
                    )}
                />
            </button>
        </div>
